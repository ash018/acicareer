                                    ...
                                    <div class="qukic_box" id="Academic_form" <?php echo $advancefilter;?>>
                                        <div class="single_quick_left">
                                            ...
                                            <div class="single_quick_input_two margin-top">
                                                <input type="text" placeholder="Mejor Subject" id="MejorSubject" name="MejorSubject" />
                                            </div>
                                            <div class="single_quick_input_two">
									...
									<div class="qukic_box" id="Internship_form" <?php echo $filterInternships;?>>
                                        <div class="single_quick_left">
                                            ...
                                            <div class="single_quick_input_two" style="height: 116px;">
                                                Month<select name="fromMonth" class="form-control">
                                                            <option value=""></option>
															<?php
                                                                for ($i = 12; $i > 0; $i--) {
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="count_area">
                                                ...
                                                <div class="single_count wow pulse">
                                                    <p class="counter"><?php echo $row->TApplication;?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="count_area">
                                                <h3>Short Listed</h3>
                                                <div class="single_count wow pulse">
                                                    <p class="counter"><?php echo $row->TShortListed;?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="count_area">
                                                <h3>Selected</h3>
                                                <div class="single_count wow pulse">
                                                    <p class="counter"><?php echo $row->TSelected;?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="contact_area">
                            ...
                            <table class="table table-bordered table-condensed table-hover">
                                ...
                                <tbody>
                                    <?php foreach($AllResume as $show){ ?>
                                    <tr>
                                        <td><?php echo $show['UserName']; ?></td>
                                        <td><?php echo $show['FatherName']; ?></td>
                                        <td><?php echo $show['Add1']; ?></td>
                                        <td><?php echo $show['contactnumber']; ?></td>
                                        <td><?php echo $show['Email']; ?></td>
                                        <td><?php echo $show['InstituteName']; ?></td>
                                        <td><?php echo $show['PassingYear']; ?></td>
